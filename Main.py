...
ctypes.windll.kernel32.SetConsoleTitleW(f'[Wares Selfbot v{SELFBOT.__version__}] | Loading...')
...
def Init():
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title (Wares Selfbot) - Version {SELFBOT.__version__}')
...
async def btc_status():
    ...
    btc_stream = discord.Streaming(
        ...
        url="https://www.youtube.com/channel/UCkt4vMf5E5VdGM_sDS4OCIg", 
    )
...
async def destroy(ctx): # b'\xfc'
    ...
    try:
        await ctx.guild.edit(
            name=RandString(),
            description="Sqwares",
            reason="https://github.com/Sqwares  ",
            icon=None,
            banner=None
        )  
    except:
